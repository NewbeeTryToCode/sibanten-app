        ...
        <div class="row">
          <div class="col-12">
            <nav class="main-nav">
              <!-- ***** Logo Start ***** -->
              <a href="">
                <img src="assets/images/logo-banten2.png" style="height:85px; width:85px" alt="">
              </a>
              <!-- ***** Logo End ***** -->
              <!-- ***** Menu Start ***** -->
              <ul class="nav">
              ...
              <div class="col-lg-6 align-self-center">
                ...
                >
                  <div class="row">
                    <div class="col-lg-12">
                      <h6>SiBanten App</h6>
                      <h2>Sistem Informasi Banten</h2>
                      <p>Cari informasi terkait banten yang ingin anda ketahui dengan sekali klik. SiBanten menyediakan berbagai informasi banten yang diperlukan sehingga mempermudah untuk media pembelajaran.
                      </p>
                    </div>
                    <div class="col-lg-12">
                      <div class="border-first-button">
              ...
              >
                <div class="about-right-content">
                  <div class="section-heading">
                    <h6>About Us</h6>
                    <h4>Apa itu SiBanten <em>App</em></h4>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            ...
            >
              <h6>Our Services</h6>
              <h4><em>Fitur</em> Yang Ditawarkan</h4>
              <div class="line-dec"></div>
            </div>
          </div>
          <div class="col-lg-12">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-5">
            ...
            >
              <h6>Our Datasets</h6>
              <h4>See Our Recent <em>Banten</em></h4>
              <div class="line-dec"></div>
            </div>
          </div>
        </div>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <p>
              Copyright © 2022 SiBanten App. All Rights Reserved.
              <br />Design:
              <a
                href="https://github.com/NewbeeTryToCode"
                target="_parent"
